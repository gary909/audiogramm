    ...
    return (
      <div className="Search">
        ...
        <div>
          ...
          <FormField label="Audiogramm" value={this.state.search} name="search" type="text" placeholder="insert something" inputchange={(e) => this.handleSearchInput(e)} />
        </div>
        ...
        */}
        {this.state.apiHash.filter(el => el.hashTag.toLowerCase().includes(this.state.search.toLowerCase())).map((el, i) => { return <AudioComp key={i} backgroundNr={i} hashTag={el.hashTag} user={el.user} likes={el.likes} /> })}
